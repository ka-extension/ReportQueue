...
import com.ethanmcdonough.ReportQueue.models.OAuthCallbackExec;

@WebServlet(name = "oauthcallback", value = { "/submit/callback/*" }, asyncSupported = true)
public class OAuthCallback extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		executor.execute(new OAuthCallbackExec(ctx));
	}
}
